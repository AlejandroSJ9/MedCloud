...
public class ClinicalDocumentMapper {
    ...
    public ClinicalDocumentDto toDto(ClinicalDocument entity) {
        ...
        return ClinicalDocumentDto.builder()
                ...
                .uploadedByEpsId(entity.getUploadedBy() != null && entity.getUploadedBy().getId() != null ? entity.getUploadedBy().getId().toString() : null)
                .epsName(entity.getUploadedBy() != null ? entity.getUploadedBy().getEpsName() : null)
                .doctorName(entity.getDoctorName())
                .doctorDocumentNumber(entity.getDoctorDocumentNumber())
                .doctorSpecialty(entity.getDoctorSpecialty())
                .patientDiagnosisInProgress(entity.getPatient() != null ? entity.getPatient().isDiagnosisInProgress() : null)
                .kind(entity.getKind())
